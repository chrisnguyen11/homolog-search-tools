...
def _alphabetized_accessions(query_accession, target_accession):
    """
...
def read_transform_tblastout(path_or_buff, sep:str="\t") -> pd.DataFrame:
    ...
    df[["Accession_1", "Accession_2"]] = df[["Query_Accession", "Target_Accession"]].apply(_alphabetized_accessions, axis=1)
